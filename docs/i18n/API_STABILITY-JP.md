...
- **パッチバージョン** (0.1.x → 0.2.1): バグ修正、新機能（Stable APIは変更なし）
- **マイナーバージョン** (0.1.x → 0.2.1): 新機能、Experimental→Stable昇格の可能性
...
- 初期開発では0.4.x-0.8.xのバージョン番号が使用されていましたが、後に0.2.xシリーズに統合されました。現在のv0.2.1は、v0.1.6バージョンリセットのセキュリティ強化と品質改善、およびその後の機能強化を含んでいます。
