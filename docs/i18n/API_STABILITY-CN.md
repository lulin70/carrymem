...
- **补丁版本** (0.1.x → 0.3.0): Bug 修复、新功能（Stable API 不变）
- **次版本** (0.1.x → 0.3.0): 新功能、Experimental→Stable 升级可能
...
- 早期开发使用了 0.4.x-0.8.x 版本号，后统一为 0.2.x 系列。当前 v0.3.0 包含了 v0.1.6 版本重置的安全加固和质量改进，以及后续功能增强。
