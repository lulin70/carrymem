...
### Version History
- **v0.4.1** (Current): P0/P1/P2 maturity fixes, RecallCache fine-grained invalidation, PBKDF2 600k, multi-stage Dockerfile, release.yml with version consistency gate
