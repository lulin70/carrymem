...
DOMAIN_VOCABULARY = {
    "coding": {
        "keywords": [
            ...
            "python", "java", "javascript", "typescript", "rust", "golang", "c++",
            "ruby", "php", "swift", "kotlin", "scala",
            # Frameworks & tools
            "react", "vue", "angular", "django", "flask", "fastapi", "spring",
            "node", "docker", "kubernetes", "git", "github", "vscode", "ide",
            "debug", "deploy", "api", "backend", "frontend", "compiler",
            "database", "sql", "postgresql", "mysql", "redis", "mongodb",
            # Dev concepts
            "refactor", "code review", "pull request", "merge", "branch",
            "unit test", "integration test", "ci/cd", "pipeline",
            "algorithm", "data structure", "design pattern", "architecture",
        ],
        "zh": [
            "编程", "代码", "开发", "程序", "软件", "数据库", "框架",
            "前端", "后端", "部署", "调试", "接口", "服务器",
        ],
        "ja": [
            "プログラミング", "コード", "開発", "ソフトウェア", "データベース",
            "フレームワーク", "フロントエンド", "バックエンド", "デプロイ",
        ],
    },
    "writing": {
        "keywords": [
            "blog", "article", "draft", "publish", "editor", "writing",
            "content", "audience", "tone", "style guide", "copywriting",
            "markdown", "wordpress", "seo", "headline", "subtitle",
            "narrative", "storytelling", "proofread", "revision",
        ],
    ...
    "research": {
        "keywords": [
            "paper", "research", "study", "hypothesis", "experiment",
            "peer-reviewed", "citation", "methodology", "analysis",
            "literature review", "thesis", "dissertation", "journal",
            "conference", "arxiv", "dataset", "statistical", "correlation",
        ],
    ...
    "management": {
        "keywords": [
            "sprint", "standup", "backlog", "roadmap", "milestone",
            "stakeholder", "deadline", "resource", "budget", "timeline",
            "agile", "scrum", "kanban", "jira", "okr", "kpi",
            "team lead", "project manager", "deliverable", "scope",
        ],
    ...
    "data": {
        "keywords": [
            ...
            "data pipeline", "etl", "warehouse", "lakehouse",
            "pandas", "numpy", "jupyter", "notebook", "spark",
            "feature engineering", "prediction", "classification",
        ],
