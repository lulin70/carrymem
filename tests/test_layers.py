...
class TestSemanticClassifier(unittest.TestCase):
    ...
    def test_classify_with_mocked_llm(self):
        ...
        mock_response.choices[0].message.content = (
            '{"memory_type": "user_preference", "tier": 2, "confidence": 0.9, "reason": "test"}'
        )
    ...
    def test_classify_with_context(self):
        ...
        mock_response.choices = [MagicMock()]
        mock_response.choices[0].message.content = (
            '{"memory_type": "correction", "tier": 3, "confidence": 0.8, "reason": "test"}'
        )
    ...
    def test_classify_with_execution_context(self):
        ...
        mock_response.choices = [MagicMock()]
        mock_response.choices[0].message.content = (
            '{"memory_type": "task_pattern", "tier": 3, "confidence": 0.7, "reason": "test"}'
        )
    ...
    def test_classify_none_context(self):
        ...
        mock_response.choices = [MagicMock()]
        mock_response.choices[0].message.content = (
            '{"memory_type": "fact_declaration", "tier": 4, "confidence": 0.7, "reason": "test"}'
        )
        ...
        rules = [
            {
                ...
                "tier": 2,
                "action": "extract",
                "description": "Chinese preference",
                "language": "zh-cn",
            },
            {
                "pattern": r"prefer",
                ...
                "tier": 2,
                "action": "extract",
                "description": "English preference",
                "language": "en",
            },
        ]
        matcher = RuleMatcher(rules)
