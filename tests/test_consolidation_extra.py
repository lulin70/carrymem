...
class TestFindDuplicatesExtra:
    ...
    def test_below_similarity_threshold(self):
        ...
        memories = [
            ...
            {
                "content": "The weather is nice today in Tokyo",
                "type": "personal_fact",
                "storage_key": "b",
            },
        ]
...
class TestConsolidateExtra:
    ...
    def test_decay_between_thresholds(self):
        ...
        all_keys = [m["storage_key"] for m in report["to_decay"]] + [m["storage_key"] for m in report["to_forget"]]
...
class TestConsolidateP2Extra:
    ...
    def test_p0_report_already_requested(self):
        ...
        memories = [
            ...
            {
                "content": "I work at Google as senior engineer",
                "type": "personal_fact",
                "storage_key": "b",
                "confidence": 0.9,
                "created_at": now,
...
class TestFindSemanticClustersExtra:
    ...
    def test_session_summary_and_preference_excluded(self):
        ...
        memories = [
            ...
            {
                "content": "User discussed Python again",
                "type": "session_summary",
                "storage_key": "d",
                "confidence": 0.8,
                "created_at": now,
...
class TestStoredMemoryFromDictExtra:
    ...
    def test_from_dict_with_string_last_accessed_at(self):
        ...
        data = {
            ...
            "content": "test",
            "storage_key": "key1",
            "last_accessed_at": "2025-06-15T10:00:00",
        }
        sm = StoredMemory.from_dict(data)
