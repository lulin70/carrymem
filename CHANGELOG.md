...
| `extensions/vscode-carrymem/test/runTests.js` | **TD-061c**: New mocha test runner for VSCode extension host — creates Mocha instance (BDD, 30s timeout), loads `extension.test.js`, runs tests, exits with appropriate code |
